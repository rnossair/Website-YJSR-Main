  ...
  if (winWidth < 992) {
    for (grIndex in group_list) {
      ...
      for (var i = 0; i < len; i++) {
        postContainer.getElementsByClassName("image-holder")[i].style =
          "display: table-row";
        postContainer.getElementsByClassName("preview-image")[i].style =
          "width: 100%; border-radius: 18px";
        postContainer.getElementsByClassName("preview-image")[i].src =
          "/assets/thumbnails/portrait/" +
          Post_List[group_list[grIndex]][i].image_source;
    ...
    for (i = 0; i < matches_found.length; i++) {
      ...
      resultsContainer.getElementsByClassName("res-image-holder")[i].style =
        "display: table-row";
      resultsContainer.getElementsByClassName("res-preview-image")[i].style =
        "width: 100%; border-radius: 18px";
      resultsContainer.getElementsByClassName("res-preview-image")[i].src =
        "/assets/thumbnails/portrait/" + Post.image_source;
    ...
    for (grIndex in group_list) {
      ...
      for (var i = 0; i < len; i++) {
        postContainer.getElementsByClassName("image-holder")[i].style =
          "display: table-cell";
        postContainer.getElementsByClassName("preview-image")[i].style =
          "height: 138px; width: 138px; border-radius: 18px;";
        postContainer.getElementsByClassName("preview-image")[i].src =
          "/assets/thumbnails/landscape/" +
          Post_List[group_list[grIndex]][i].image_source;
        postContainer.getElementsByClassName("post-preview-holder")[i].style =
          "display: table-cell";
      }
    ...
    for (i = 0; i < matches_found.length; i++) {
      ...
      resultsContainer.getElementsByClassName("res-preview-image")[i].style =
        "height: 138px; width: 138px; border-radius: 18px;";
      resultsContainer.getElementsByClassName("res-preview-image")[i].src =
        "/assets/thumbnails/landscape/" + Post.image_source;
      resultsContainer.getElementsByClassName("res-post-preview-holder")[
        i
...
const Post_List = {
  sci: [ 
    ...
    },
   {
    ...
    },
    {
      ...
      subtitle:
        "The Answer to Cancer We’ve Been Waiting For? A Deep Dive into the Latest Breakthroughs",
      author: "Tamera Simon",
      author_contact: "",
      publish_date: "July 23, 2023",
    ...
    },
    {
      ...
      post_destination:
        "/Posts/Impacts_of_second_hand_smoking_on_household_plants.html",
    },
    {
      ...
      post_destination:
        "/Posts/Understanding_Keto_Dieting_for_Vegetarians.html",
    },
    {
      title:
        "STEM Education: Empowering a Transformed Future in an Ever-Evolving World",
      subtitle: "",
      author: "Afreen Hossain",
      author_contact: "",
      ...
      post_destination:
        "/Posts/Empowering-Transformed-Future-in-Ever-Evolving-World.html",
    },
    {
    ...
    },
    {
      ...
      subtitle:
        "Balancing Focus and Consequences: Exploring the Complexities of Adderall Use in Therapeutic Contexts.",
      author: "Kate Rutter",
      author_contact: "",
    ...
    {
      title:
        "Global Warming And Its Impact On The Phenology Of Birds And Other Wildlife",
      subtitle:
        "Shifting Rhythms of Life: Investigating the Influence of Global Warming on Wildlife Phenology and Ecosystem Dynamics.",
      author: "Xyrene Amansec",
      author_contact: "",
      publish_date: "June 25, 2023",
      image_source:
        "global_warming_and_its_impact_on_the_phenology_of_birds_and_other_wildlife.jpg",
      post_destination:
        "/Posts/Global-warming-and-its-impact-on-the-phenology-of-birds-and-other-wildlife.html",
    },
    {
      title:
        "Anthropogenic Habitat Alteration and the Demographic Decline of Scantius Aegyptius",
      subtitle:
        "The Human Footprint on Scantius Aegyptius: Investigating the Ecological Consequences of Anthropogenic Habitat Alteration.",
      ...
      image_source:
        "anthropogenic_habitat_alteration_and_the_demographic_decline_of_scantius_aegyptius.png",
      post_destination:
        "/Posts/Anthropogenic-habitat-alteration-and-the-demographic-decline-of-scantius-aegyptius.html",
    },
    {
    ...
    },
    {
      ...
      post_destination:
        "/Posts/Designer_Babies-_Creating_A_Better_Generation_Or_Not",
    },
    {
      title: "The Etiology and Treatment of Preeclampsia Among Pregnant Women",
      subtitle:
        "Together let’s explore the complex biological mechanisms and treatments of one of the most notorious pathologies in the field of maternal-fetal medicine.",
      author: "Jared Ortiz-Luis",
      author_contact: "",
      publish_date: "June 14, 2023",
      image_source: "the_ethiology_and_treatment_of_preeclampsia.jpg",
      post_destination:
        "/Posts/The-Ethiology-and-Treatment-of-Preeclampsia-among-pregnant-women.html",
    },
    {
      title:
        "Music as Informational Art: Debunking the Myth of 'Informative Garbage'",
      subtitle: "",
    ...
    },
    {
      ...
      post_destination:
        "/Posts/Honey-Water-and-Fertilizer-Effect-on-Plant-Growth.html",
    },
    {
      title:
        "The Silent Threat: Unveiling the Connection Between Air Pollution and Mental Health",
      subtitle: "",
      author: "Ashley Lim",
      author_contact: "", // I personally dunno why does it even exists...
      ...
      post_destination:
        "/Posts/Connection-Between-Air-Pollution-and-Mental-Health.html",
    },
    {
      ...
      image_source:
        "effect_of_water_and_basic_soda_on_plant_oxidation_rated.jpg",
      post_destination:
        "/Posts/Effects-of-water-and-baking-soda-on-plant-oxidation-rates.html",
    },
    {
      ...
      post_destination:
        "/Posts/The-invisible-universe-uncovering-the-mysteries-and-wonders-of-dark-matter.html",
    },
    {
      title:
        "Unlocking the Mysteries of Oncogenes: How These Genetic Rebels Drive Cancer",
    ...
    {
      title:
        "The Truth About Bioweapons: The Science Behind Biological Destruction",
      subtitle:
        "Uncovering the Secrets of Bioweapons: Analyzing the Mechanisms and Consequences of Biological Warfare.",
      author: "Anya Trivedi",
      author_contact: "",
    ...
    },
    {
      ...
      subtitle:
        "Some might find it cute, some might find it weird, but its regenerative abilities are undeniably and scientifically fascinating.",
      author: "Maria Eduarda de Mattos Brandão",
      author_contact: "",
    ...
    },
    {
      ...
      subtitle:
        "Why do we resolutely change ourselves? And how do the people who perform these surgeries feel?",
    ...
    },
    {
      ...
      subtitle:
        "Exploring the Brain's Remarkable Ability to Adapt and Learn through Neuroplasticity",
    ...
    },
    {
      ...
      subtitle:
        "Love is a Drug: How Hormones and Neurotransmitters create Addiction and Euphoria...",
      author: "Vincent Hui",
      author_contact: "",
    ...
    },
    {
      ...
      subtitle:
        "Unraveling the Mysteries of the Musical Mind: A Neuroscientific Perspective",
      author: "Aadrika Maurya",
      author_contact: "",
      publish_date: "April 10, 2023",
    ...
    },
    {
      ...
      subtitle:
        "Revitalizing the Body's Cells with NANOG Gene Therapy: A Breakthrough in Anti-Aging Research",
      author: "Jasmine Biju",
      author_contact: "",
      publish_date: "April 1, 2023",
      image_source: "the_nanog_gene.jpg",
      post_destination:
        "/Posts/The-NANOG-gene-a-potential-for-age-reversal.html",
    },
    {
      title: "The Ethics of Human Cloning",
      subtitle:
        "Unpacking the Possibilities and Challenges of Human Cloning in the Modern Age",
      author: "Aadrika Maurya",
      author_contact: "",
    ...
    },
    {
      ...
      subtitle:
        "Looking into the questions regarding the Appropriation, Authorship, and Accountability of Art generated by Artificial Intelligence and finding answers to them.",
      author: "Armish Shayan",
      author_contact: "",
      publish_date: "March 5, 2023",
      image_source: "exploring_the_ethics_of_art.png",
      post_destination:
        "/Posts/Exploring-the-ethics-of-art-Appropriation-Authorship-Accountability.html",
    },
    {
    ...
    },
    {
      ...
      post_destination:
        "/Posts/Scientists-use-plasma-to-produce-oxygen-on-mars.html",
    },
    {
      title:
      ...
      post_destination:
        "/Posts/How-an-alligator-gene-in-farming-catfish-will-help-defend-against-infections.html",
    },
    {
    ...
    },
    {
      ...
      subtitle:
        "How Plants Overcome the Cold: Deciphering the Anti-Icing Mechanism",
      author: "Jasmine Biju",
      author_contact: "",
    ...
    },
    {
      ...
      subtitle:
        "Mind over matter: The surprising impact of perception on healing.",
      author: "Charvi Kashyap",
      author_contact: "",
    ...
    },
    {
      ...
      subtitle:
        "Let's take a look on how one of the world's deadliest virus makes it's way to accomplish their lethal mission.",
      author: "Soham Jindal",
      author_contact: "",
    ...
    },
    {
      ...
      post_destination:
        "/Posts/CRISPR-Beneficial-Effective-yet-Problematic-Healthcare.html",
    },
    {
      title:
        "Can Swarming Locusts generate as much Electricity as a Storm Cloud?",
      subtitle: "",
      author: "Jasmine Biju",
      author_contact: "",
      ...
      post_destination:
        "/Posts/Can-swarming-locusts-generate-as-much-electricity-as-storm-cloud.html",
    },
    {
      ...
      post_destination:
        "/Posts/CAR-T-Cells-eliminating-residual-tumor-cells.html",
    },
    {
    ...
    },
    {
      ...
      post_destination:
        "/Posts/The-impact-of-omega-3-and-omega-6-fatty-acids-on-depression.html",
    },
    {
      title:
        "Application of Amino-Acid based Metabolites in Early Diagnosis of MS Patients",
      subtitle: "",
      author: "Fareen Momen",
      author_contact: "",
      ...
      post_destination:
        "/Posts/Application-of-Amino-Acid-based-metabolites.html",
    },
    {
    ...
    {
      title:
        "Cloning Of Asiatic Lions In India - a solution or an even bigger problem?",
      subtitle: "",
    ...
    },
    {
      ...
      post_destination:
        "/Posts/Genetic-Basis-of-Behavior-in-Bipolar-Disorder.html",
    },
    {
    ...
    },
    {
      ...
      subtitle:
        "An impactful and successful technique to lower disease spread hidden in the shadows",
      author: "Tran Bui",
      author_contact: "",
    ...
    },
    {
      ...
      post_destination:
        "/Posts/economic-and-environmental-impact-of-medical-waste.html",
    },
    {
    ...
    },
    {
      ...
      subtitle:
        "How do the most infectious diseases invade and alter the body? Let’s dive into the cells!",
    ...
    },
    {
      ...
      subtitle:
        "Let's delve into how Warburg metabolism benefits cancer cells and fully characterizes their innate greed for glucose.",
      author: "Jared Ortiz-Luis",
      author_contact: "",
      publish_date: "July 17, 2022",
    ...
    {
      title:
        "Biotechnology in the Recombinant Production of Synthetic Human Growth Hormone",
      subtitle: "",
      author: "Anna Pham",
      author_contact: "",
    ...
    {
      title:
        "&OpenCurlyDoubleQuote;From Our Perspective&CloseCurlyDoubleQuote;: The Impact of Recent School Shootings on Mental Health",
      subtitle:
        "How the recent school shootings have affected United States students' mental health, from students’ perspective.",
      author: "Alexa Cuvilly",
      author_contact: "",
      publish_date: "July 6, 2022",
      image_source: "effect_of_school_shooting_on_children.png",
      post_destination:
        "/Posts/From-Our-Prespective-the-impact-of-recent-school-shootings-on-mental-health.html",
    },
    {
    ...
    {
      title:
        "Aphantatic Artists: The Paradoxical Relationship Between Lack of Imagination and Artwork",
      subtitle: "",
      author: "Amna Eisa",
      author_contact: "",
      publish_date: "June 28, 2022",
      ...
      post_destination:
        "/Posts/Aphantatic-artists-the-paradoxical-relationship-between-lack-of-imagination-and-artwork",
    },
    {
    ...
    {
      title:
        "United States Socio-Political Deliberation on Decreasing CO<sub>2</sub> Emissions",
      subtitle: "",
      author: "Lakshya Jaikumar",
      author_contact: "",
      publish_date: "June 16, 2022",
      image_source:
        "united_states_socio_politiclal_deliberation_on_decreasing_co2_emmisions.png",
      post_destination:
        "/Posts/United-states-socio-politiclal-deliberation-on-decreasing-co2-emmisions",
    },
    {
    ...
    {
      title:
        "Exploring Neurodegenerative Disease in the Context of American Football",
      subtitle:
        "Are the numerous severe neurological pathologies associated with this fan-favorite sport enough to convince government officials to set a minimum age requirement?",
      author: "Jared Ortiz-Luis",
      author_contact: "",
      publish_date: "June 8, 2022",
      image_source:
        "exploring_neurodegenerative_disease_in_the_context_of_american_football.png",
      post_destination:
        "/Posts/Exploring-neurodegenerative-disease-in-the-context-of-american-football",
    },
    {
    ...
    },
    {
      ...
      subtitle:
        "Learning about the different parts of the brain and what they are responsible for!",
      author: "Alexa Cuvilly",
      author_contact: "",
      publish_date: "June 7, 2022",
    ...
    },
    {
      ...
      subtitle:
        "Bacteria and viruses in action as the immune system goes on high alert.",
      author: "Ngoc Tran Bui",
      author_contact: "",
    ...
    {
      title:
        "The Concerning Effect the Omicron Variant Has on the COVID-19 Vaccine",
      subtitle: "The sequel to ‘The COVID-19 Vaccine is Not a Miracle Cure’",
      author: "Emily Jia",
      author_contact: "",
      publish_date: "May 31, 2022",
      image_source:
        "the_concerning_effect_the_omicron_variant_has_on_the_covid_19_vaccine.png",
      post_destination:
        "/Posts/The-concerning-effect-the-omicron-variant-has-on-the-covid-19-vaccine.html",
    },
    {
    ...
    },
    {
      ...
      subtitle:
        "Have you ever wondered what role physics play in something as simple as a butterfly’s flight?",
      author: "Satinder Bamrah",
      author_contact: "",
      publish_date: "May 22, 2022",
      image_source: "how_butterflies_use_jet_propulsion_for_quick_getaways.png",
      post_destination:
        "/Posts/How-butterflies-use-jet-propulsion-for-quick-getaways",
    },
    {
    ...
    },
    {
      ...
      subtitle:
        "When combined, they have saved many lives. But how are they different from each other?",
      author: "Priya Bongu",
      author_contact: "",
    ...
    {
      title:
        "Alcoholism Drug Restores Vision Loss from Macular Degeneration and Retinitis Pigmentosa",
      subtitle:
        "A promising solution to these chronic, age-related eye diseases",
    ...
    },
    {
      ...
      subtitle:
        "Is it a promising cure for genetic diseases or is it the beginning of unnatural selection?",
      author: "Arsa Satheeskumar",
      author_contact: "",
      publish_date: "May 20, 2022",
    ...
    },
    {
      ...
      subtitle:
        "Would you risk your family for a euphoric moment? My story with addiction and also the science behind it.",
    ...
    },
    {
      ...
      subtitle:
        "Appearances can be deceiving. Although there is no cure, it is one of the rarest diseases in the world.",
      author: "Anisha Patel",
      author_contact: "",
    ...
    {
      title:
        "Music & The Brain: How do they Correlate and Why is it important?",
    ...
    },
    {
      ...
      subtitle:
        "Maybe it's time to leave this world of stress and listen to our inner selves...",
      author: "Sophia Zheng",
      author_contact: "",
    ...
    },
    {
      ...
      subtitle:
        "There's no Cure for it yet, so it's better to be aware of it than to avoid it.",
      author: "Ayana Samantray",
      author_contact: "",
    ...
    },
    {
      ...
      subtitle:
        "The biggest enemy of the environment has entered out bodies and it now the biggest threat to us!",
    ...
    },
    {
      ...
      subtitle:
        "Let's see what these micro-sized organisms tell us about ourselves.",
      author: "Jared Ortiz-Luis",
      author_contact: "",
  ...
  tech: [
    ...
    },
    {
      ...
      image_source:
        "THE-FUTURE-OF-ARTIFICIAL-INTELLIGENCE-ADVANCEMENTS-AND-IMPLICATIONS.jpg",
      post_destination:
        "/Posts/THE-FUTURE-OF-ARTIFICIAL-INTELLIGENCE-ADVANCEMENTS-AND-IMPLICATIONS.html",
    },
    {
      title: "How is Technology Changing the Face of the Banking Sector?",
      subtitle:
        "Exploring Technological Innovations Redefining the Banking Landscape.",
      author: "Ritika Tyagi",
      author_contact: "",
      publish_date: "June 22, 2023",
      image_source:
        "how_technology_is_changing_the_face_of_the_banking_sector.jpg",
      post_destination:
        "/Posts/How-is-technology-changing-the-face-of-banking-sector.html",
    },
    {
    ...
    },
    {
      ...
      post_destination:
        "/Posts/Quantum-Computing-Unlocking-Power-Quantum-Mechanics.html",
    },
    {
      title: "The Power of APIs in Modern Software Development",
      subtitle:
        "Code Connectors: Harnessing the Potential of APIs for Advanced Software Development.",
      author: "Aurum Mandal",
      author_contact: "",
      publish_date: "June 12, 2023",
      image_source: "the_power_of_apis_in_modern_software_development.jpg",
      post_destination:
        "/Posts/The-power-of-APIs-Modern-Software-Development.html",
    },
    {
      ...
      post_destination:
        "/Posts/Virtual-reality-in-education-navigating-the-challenges-and-unlocking-the-potential.html",
    },
    {
      ...
      publish_date: "June 11, 2023",
      image_source:
        "synergy_of_AI_and_design_Unleashing_the_power_of_innovation.jpg",
      post_destination:
        "/Posts/synergy_of_AI_and_design_Unleashing_the_power_of_innovation.html",
    },
    {
      title: "The Metaverse: Can Technology Save An Island",
      subtitle:
        "Digital Dimensions and Island Preservation: Unleashing the Potential of the Metaverse",
      author: "Ariana Walcott",
      author_contact: "",
      publish_date: "June 6, 2023",
      image_source: "the_metaverse_can_technology_save_an_island.jpg",
      post_destination:
        "/Posts/The-metaverse-can-technology-save-an-island.html",
    },
    {
    ...
    },
    {
      ...
      subtitle:
        "Exploring Innovations for Enhancing Autism Support and Inclusion through Technology",
      author: "Aadrika Maurya",
      author_contact: "",
      publish_date: "April 25, 2023",
      image_source:
        "the_role_of_technology_in_supporting_individual_with_autism.png",
      post_destination:
        "/Posts/The-Role-of-Technology-in-supporting-individuals-with-autism.html",
    },
    {
      title: "Space-Based Solar Power",
      subtitle:
        "Determining the efficiency of space-based solar panels in the energy needs of the world.",
    ...
    },
    {
      ...
      subtitle:
        "These two are some of the most easily confused carreer fields, here are the differences between them.",
      author: "Surayya Yuldashova",
      author_contact: "",
      publish_date: "January 14, 2023",
      image_source: "difference_between_it_and_cs.png",
      post_destination:
        "/Posts/Difference-between-computer-science-and-IT.html",
    },
    {
    ...
    },
    {
      ...
      subtitle:
        "Reflections on the Future of Virtual Reality in Education and the Possibilities of Change",
      author: "Aymen Jadda",
      author_contact: "",
    ...
    },
    {
      ...
      post_destination:
        "/Posts/MedIm-Artificial-Intelligence-System-for-Pneumonia-Detection.html",
    },
    {
    ...
    },
    {
      ...
      post_destination:
        "/Posts/How-machine-learning-can-aid-the-visually-impaired.html",
    },
    {
    ...
    },
    {
      ...
      subtitle:
        "The era of efficient opportunities, investments, and capacity expansion of network industries has begun with the decision-making behavior in economics!",
      author: "Arushi Jain",
      author_contact: "",
      publish_date: "June 26, 2022",
      image_source:
        "understanding_network_economics_from_basics_to_applications.png",
      post_destination:
        "/Posts/Understanding-network-economics-from-basics-to-applications",
    },
    {
      title:
        "Effects of Digital Divide on Education in India Amidst the Pandemic",
      subtitle: "",
      author: "Arushi Jain",
      author_contact: "",
      publish_date: "June 25, 2022",
      ...
      post_destination:
        "/Posts/Effects-of-digital-divide-on-education-in-india-amidst-the-pandamic",
    },
    {
      ...
      image_source:
        "nuclear_transmutation_and_how_we_can_turn_lead_into_gold.png",
      post_destination:
        "/Posts/Nuclear-transmutation-and-how-we-can-turn-lead-into-gold",
    },
    {
      ...
      publish_date: "June 5, 2022",
      image_source:
        "how_a_machine_learning_model_can_be_used_to_detect_skin_cancer.png",
      post_destination:
        "Posts/How-a-machine-learning-model-can-be-used-to-detect-skin-cancer",
    },
    {
      ...
      image_source:
        "the_relationship_between_data_science_childhood_obesity_cure.png",
      post_destination:
        "/Posts/The-relationship-between-data-science-and-childhood-obesity-cure",
    },
    {
      title:
        "Artificial Intelligence and Vaccines: Paradigm Shift in Immunology",
      subtitle:
        "Can the best friend of humanity help it fight its biggest foe?",
      author: "Vanya Sahi",
      author_contact: "",
      publish_date: "April 6, 2022",
  ...
  eng: [
    {
      ...
      post_destination:
        "/Posts/What-is-engineering-and-what-do-engineers-do.html",
    },
    {
    ...
    },
    {
      ...
      subtitle:
        "Driving our Way Towards a Sustainable Future with Hydrogen Fuel Cell Technology",
      author: "Harya Vishwanath",
      author_contact: "",
      publish_date: "April 26, 2023",
      image_source: "hydrogen_powered_car_fuel_cell_engine_technology.png",
      post_destination:
        "/Posts/Hydrogen-powered-car-fuel-cell-engine-technology.html",
    },
    {
      title:
        "Leveraging Digital Twins to Unlock the Potential of the Industrial Internet of Things",
      ...
      post_destination:
        "/Posts/Leveraging-digital-twins-to-unlock-the-potential-of-the-industrial-internet-of-things.html",
    },
    {
    ...
    },
    {
      ...
      subtitle:
        "Discovering Relationships Between Position, Velocity, and Acceleration",
      author: "Julia Huang",
      author_contact: "", // I personally dunno why does it even exists...
    ...
    {
      title:
        "Effective Project Management: Potential Cure for Stress and Depression in Construction and Engineering?",
      subtitle: "",
    ...
    },
    {
      ...
      subtitle:
        "Faults in Engineering Sector somethimes lead to Disasters, but should we simply blame engineering for that?",
      author: "Juliana Russell",
      author_contact: "",
      publish_date: "May 21, 2022",
    ...
    },
    {
      ...
      subtitle:
        "“Girls aren’t built for engineering jobs. You can't do that.”<br><b>“Yes, I can!</b>”",
      author: "Asher Segun-Olasanmi",
      author_contact: "",
      publish_date: "May 21, 2022",
...
publish_date: "August 6, 2023",
    ...
    },
    {
      ...
      post_destination:
        "/Posts/Unsolvable-Simplicity-the-Collatz-Conjecture.html",
    },
    {
    ...
    },
    {
      ...
      image_source:
        "The_Power_of_Machine_Learning_in_Mathematics-_Transforming_STEM.jpg",
      post_destination:
        "/Posts/The_Power_of_Machine_Learning_in_Mathematics-_Transforming_STEM.html",
    },
    {
    ...
    },
    {
      ...
      post_destination:
        "/Posts/The-application-of-sorting-algorithms-in-N-dimensional-space.html",
    },
    {
    ...
    },
    {
      ...
      post_destination:
        "/Posts/History-of-golden-ratio-and-its-relation-to-beauty.html",
    },
    {
      ...
      post_destination:
        "/Posts/Reference-frames-and-galileo-transformation-formulas.html",
    },
    {
...
function postRender(group, number) {
  ...
  for (let i = renderedPosts; i < number; i++) {
    postContainer =
      corresp_post_cont_dict[group].getElementsByClassName("post-body")[0];
